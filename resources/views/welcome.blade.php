                ...
                <div class="col-sm-4">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                            ...
                            <div class="why_list_text pt-3"><p>Un equipamiento completo de diagnóstico y tratamiento, y un plantel profesional reconocido.</p></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                                ...
                                <div class="why_list_text pt-3"><p>En Moscati, la constante capacitación y evaluación de nuestros médicos es primordial, lo cual nos permite garantizar la mejor atención a los pacientes cumpliendo los estándares más altos del hospital. Un equipo formado por  personas más talentosas  dedicadas a su profesión y comprometidas con la salud.</p></div>
                        </div>
                    </div>
                </div>
                <div class="col-sm-4">
                    <div class="row">
                        ...
                        <div class="col-sm-9">
                                ...
                                <div class="why_list_text pt-3"><p class="text-white">Contamos con 13 quirófanos equipados con el instrumental quirúrgico más avanzado en la actualidad, uno de ellos con cardio ensuite. El cunero está aislado y es monitoreado las 24 horas del día por personal capacitado para brindar la mejor atención neonatal.</p></div>
                        </div>
                    </div>
                </div>
